...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(default="/cpfs01/user/chenyukun/xlm-roberta-large", metadata={"help": "the model name"})
    # lora_weights: Optional[str] = field(default='/cpfs01/user/chenyukun/llama/save')
    dataset_name: Optional[str] = field(default="/cpfs01/user/chenyukun/rw_dataset", metadata={"help": "the model name"})
    ...
    output_dir: Optional[str] = field(default="/cpfs01/user/chenyukun/reward", metadata={"help": "the output directory"})
...
if script_args.use_peft:
    peft_config = LoraConfig(r=4, lora_alpha=16, bias="none", task_type="SEQ_CLS", modules_to_save=["scores"])
else:
    peft_config = None
...
trainer = RewardTrainer(
    ...
    max_length=512#script_args.seq_length,
)
